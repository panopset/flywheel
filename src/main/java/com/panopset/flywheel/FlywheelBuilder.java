...
public final class FlywheelBuilder {
  ...
  /**
   * Set target directory. This is where your output is going. Directory structures will be created
   * as needed, and <b>existing files are wiped without warning</b>.
   *
   * @param newTargetDirectory All output files specified by the ${&#064;f fileName} command are
   *        relative paths based here.
   * @return Builder.
   */
  ...
  /**
   * You do not need to specify this if you are specifying a File in Flywheel.Builder.file, as the
   * parent directory of the main template file would be used. This method would rarely be needed,
   * but is available for flexibility.
   *
  ...
  /**
   * If you supply a String array here, the <b>file</b> Flywheel.Builder method will be ignored.
   *
  ...
  /**
   * If you supply a List of Strings here, do not use the <b>file</b> Flywheel.Builder method.
   *
   ...
   *
   * @param additionalMap Additional map. In the case of duplicate keys, the most recently added map
   *        takes precedence.
   * @return Builder.
   */
  ...
  /**
   * Register any instantiated objects you want available to the Execute command here. You will be
   * able to use any method of those objects that accept 0 or more String parameters, and that
   * return a single String result. Recommended, but not required, to qualify objects with their
   * path names. com.panopset.flywheel.Flywheel is registered automatically.
   *
  ...
  /**
   * Define replacements in a file specified by the replacements parameter. First line of that file
   * contains a single character that is the separator for subsequent lines that define
   * replacements.
   *
  ...
  /**
   * If you specify a writer, you need not specify a targetDirectory, as it would be meaningless,
   * and any File commands are ignored, as you are intending your output to be a StringWriter.
   *
