...
public final class Flywheel implements MapProvider {
  ...
  /**
   * Called if something unexpected happens. Diagnostic messages are logged, in addition to the
   * message.
   *
   ...
   * Used by debuggers.
   *
   * @return true if the stop method was called for any reason, usually some error condition.
   */
